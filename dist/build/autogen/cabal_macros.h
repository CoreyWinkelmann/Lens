...
/* package my-lens-tutorial-0.1.0.0 */
#ifndef VERSION_my_lens_tutorial
#define VERSION_my_lens_tutorial "0.1.0.0"
#endif /* VERSION_my_lens_tutorial */
#ifndef MIN_VERSION_my_lens_tutorial
#define MIN_VERSION_my_lens_tutorial(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_lens_tutorial */
...
#define CURRENT_PACKAGE_KEY "my-lens-tutorial-0.1.0.0-KHKEQNTbHf77G7DrHMqNXT"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "my-lens-tutorial-0.1.0.0-KHKEQNTbHf77G7DrHMqNXT"
